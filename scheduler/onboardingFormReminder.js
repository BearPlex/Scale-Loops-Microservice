...
async function sendOnboardingReminders() {
    ...
    // const today = moment("2025-02-12").startOf("day").format("YYYY-MM-DD");
    try {
        ...
        for (const mediator of mediators) {
            ...
            for (const caseData of mediatorCases) {
                ...
                console.log(
                    "11todaysReminders", emailReminders, emailReminders?.reminders, today)
                ...
                console.log(
                    "22todaysReminders", todaysReminders, todaysReminders.length)
                ...
                // Then mark as sent
                // await markReminderAsSent(emailReminders.id, reminderType, "onBoarding");
                await Promise.all(
